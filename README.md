...
|-------------|------------|-----------|--------|-----|
| Forestry ARR | tCO₂e / yr | $26 rated BBB+ (~$14 unrated) | 3 % | 25 % |
| REDD+ | tCO₂e / yr | $6 | 2 % | 41 % |
| Biochar | tCO₂e / yr | $130–200 | 2 % | 6 % |
| Agroforestry | tCO₂e / yr | $18–20 | 3 % | 28 % |
| Cocoa (commodity) | tons / yr | market price | 3 % | 22 % |

Vol is **revenue** volatility after forward sales, not spot carbon volatility —
the sample data assumes 30 % offtake coverage for nature-based projects and 70 %
for biochar. Sources for every figure: `docs/SAMPLE_DATA_SOURCES.md`.
...
```
examples/ui_sample/
  vehicle_1_forestry/      — 3 East Africa ARR reforestation projects
  vehicle_2_agroforestry/  — 3 West Africa agroforestry projects
  vehicle_3_mixed/         — REDD+, biochar, and an ARR/agroforestry hybrid
```

All nine files are generated by `scripts/build_sample_data.py` from unit
economics documented in `docs/SAMPLE_DATA_SOURCES.md`.
